...
export default function OrganizerDetailPage() {
  const { id = '' } = useParams()
  const { data, loading, error, reload } = useApiResource(() => api.getOrganizer(id))
